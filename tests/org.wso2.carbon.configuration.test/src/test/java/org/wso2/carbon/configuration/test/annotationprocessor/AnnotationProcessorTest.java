 ...
 */
package org.wso2.carbon.configuration.test.annotationprocessor;
...
public class AnnotationProcessorTest {
    ...
    public void initClass() {
        ...
        packagePath = Paths.get("src", "test", "java", "org", "wso2", "carbon", "configuration", "test",
                "annotationprocessor").toString();
    ...
    private void verifyTempConfigFile() {
        ...
        try {
            ...
            for (String line : lines) {
                if (line.contains("org.wso2.carbon.configuration.test.annotationprocessor.Configurations")) {
                    classFound = true;
                }
            }
